...
describe('beowulf.auth: Crypto', function() {
  ...
  it('sign', function() {
    this.timeout(10000);
    var private_key = PrivateKey.fromSeed('gDs7knMWZ1SPvJQgw2gpZDxucJhWUjDGownerDlWXBWmGaimlAVT8iSl7x4H9orkO8Qcj');
    return (() => {
      var result = [];
      for (var i = 0; i < 10; i++) {
